...
export const LogIn = () => {
  ...
  //     logForm.placeholder = 'Логин не мог быть больше 12';
  ...
  //   } else if (2 > 1) {
  //     const logFormSpaceCheck = e.target.value === '';
  //     if (logFormSpaceCheck === true) {
  //       setLogin(e.target.value = '')
  //       const logForm = document.querySelector(".logwindow__inp1")
  ...
  //       setLogin(e.target.value = '')
  //       const logForm = document.querySelector(".logwindow__inp1")
  //       logForm.placeholder = 'Поле не может иметь пробелы'
  //     }
  //   }
  // }
  ...
  //   if (passVaL.length > 19) {
  //     setPassword(e.target.value = '')
  //     setPasswordError('Пароль не мог быть больше 19')
  //     const passForm = document.querySelector(".logwindow__inp2")
  //     passForm.placeholder = 'Пароль не мог быть больше 19'
  //   } else if (2 > 1) {
  //     const passFormSpaceCheck = e.target.value === '';
  //     if (passFormSpaceCheck === true ) {
  //       setPassword(e.target.value = '')
  ...
  //     } else {
  //       setPassword(e.target.value = '')
  //       setPasswordError('Пароль не мог иметь пробелы')
  //       const passForm = document.querySelector(".logwindow__inp2")
